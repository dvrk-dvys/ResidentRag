...
if __name__ == "__main__":
    ...
    print(f"Hit@{top_k}: {hybrid_hit:.3f} | MRR@{top_k}: {hybrid_mrr:.3f} | MAP@{top_k}: {hybrid_map:.3f} | nDCG@{top_k}: {hybrid_ndcg:.3f}")
    ...
    print(f"Hit@{top_k}: {es_hit:.3f} | MRR@{top_k}: {es_mrr:.3f} | MAP@{top_k}: {es_map:.3f} | nDCG@{top_k}: {es_ndcg:.3f}")
    ...
    print(f"Hit@{top_k}: {qdrant_hit:.3f} | MRR@{top_k}: {qdrant_mrr:.3f} | MAP@{top_k}: {qdrant_map:.3f} | nDCG@{top_k}: {qdrant_ndcg:.3f}")
