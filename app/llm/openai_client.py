...
def llm(prompt, sys_prompt=None, model=DEFAULT_MODEL, tools=None):
    """
...
def chat_with_tools(
    ...
    for call in tool_calls:
        ...
        result = function_map[name](**args)  # run your Python fn
    ...
    r2 = client.chat.completions.create(
        model=model,
        messages=messages + [
            {"role": "assistant", "content": m1.content or "", "tool_calls": m1.tool_calls}
        ] + tool_messages,
        temperature=temperature,
        max_tokens=max_tokens,
    )
...
if __name__ == "__main__":
    ...
    context=("You are a medical llm assistant answering questions to the best of your ability using pub med research papers"
